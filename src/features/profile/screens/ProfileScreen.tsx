...
export const ProfileScreen = () => {
  ...
  const { theme, currency, notificationsEnabled, language } =
  ...
  const renderSettingItem = (
    ...
    >
      <View style={styles.settingLeft}>
        ...
        <Text style={[styles.settingText, { color: danger ? colors.error : colors.text.primary }]}>
          {label}
        </Text>
      </View>
            ...
            {renderSettingItem(
              ...
              <TouchableOpacity
                onPress={() => {
                  ...
                  const nextLanguage = languages[(currentIndex + 1) % languages.length] as any;
                  dispatch(setLanguage(nextLanguage));
                }}
              >
                <Text style={[styles.settingValue, { color: colors.text.primary }]}>
                  {language === 'en' ? 'English' : language === 'ru' ? 'Русский' : 'Українська'}
                </Text>
              </TouchableOpacity>
            )}
            {renderSettingItem(
